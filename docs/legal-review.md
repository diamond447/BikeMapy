...
| Mapy.com                  | [Mapy.com terms](https://mapy.com/en/terms), [licensing page](https://licence.mapy.cz/?doc=mapy_pu&lang=en), retrieved 2026-09-14 | The Mapy.com terms page was reachable and describes Mapy.com as a map, search, planning, and user-content service. The licensing URL redirected to `licence.mapy.com` but the licensing page was not accessible from this environment. BikeMapy fetches GPX through an unofficial, replaceable adapter constrained to HTTPS Mapy hosts; this is not evidence that Mapy.com authorizes automated access, scraping, exporter use, or redistribution. Provider permission for the selected exporter, server-side fetching, private retention, and public GPX remains unresolved. |
...
assertions and production evidence. BikeForum, Mapy.com terms, OpenFreeMap,
OSM, and Cloudflare Web Analytics pages were reachable. The Mapy licensing
redirect, Google Fonts FAQ, Sentry legal pages, Cloudflare's Turnstile Privacy
Policy, Czech Industrial Property Office search, and EUIPO search were blocked
or returned an upstream 403/404 in this sandbox. A reachable page is
not permission to crawl, export, or republish its content; an inaccessible
page is not evidence that permission is absent. The owner must attach provider
communications/account screenshots, the trademark search result, and the
