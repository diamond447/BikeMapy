...
build:
	cd frontend && VITE_PUBLIC_SITE_URL=$${VITE_PUBLIC_SITE_URL:-http://localhost:5173} VITE_API_URL=$${VITE_API_URL:-http://localhost:8000} VITE_ENABLE_REPORTS=$${VITE_ENABLE_REPORTS:-false} corepack pnpm build
