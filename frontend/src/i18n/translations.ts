...
export const translations = {
  en: {
    ...
    gameMapDescription: 'Explore member traces by date. Activity titles, exact times, and speeds never leave the private game.',
    ...
    gameMapSignedOutDescription: 'Your competition traces are visible only to authenticated members.',
  ...
  cs: {
    ...
    gameMapDescription: 'Prohlížejte členské stopy podle data. Názvy aktivit, přesné časy ani rychlosti neopouštějí soukromou hru.',
